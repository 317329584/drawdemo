...
import com.goldgov.demo.view.draw.CanvasDrawer;
import com.goldgov.demo.view.draw.PathDrawer;
import com.goldgov.demo.view.draw.SerializablePath;
import com.goldgov.demo.view.gestures.creator.GestureCreator;
import com.goldgov.demo.view.gestures.creator.GestureCreatorListener;
import com.goldgov.demo.view.gestures.scale.GestureScaleListener;
import com.goldgov.demo.view.gestures.scale.GestureScaler;
import com.goldgov.demo.view.gestures.scale.ScalerListener;
import com.goldgov.demo.view.gestures.scroller.GestureScrollListener;
import com.goldgov.demo.view.gestures.scroller.GestureScroller;
import com.goldgov.demo.view.gestures.scroller.ScrollerListener;

public class DrawableView extends View implements View.OnTouchListener,
		ScrollerListener, GestureCreatorListener, ScalerListener {
	...
	public void setConfig(DrawableViewConfig config) {
		if (config == null) {
			throw new IllegalArgumentException(
					"Paint configuration cannot be null");
		}
	...
	public Bitmap obtainBitmap() {
		return obtainBitmap(Bitmap.createBitmap(canvasWidth, canvasHeight,
